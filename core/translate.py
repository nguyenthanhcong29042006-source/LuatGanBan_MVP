...
QUY TẮC
1. Dịch sang tiếng Mông Trắng (Hmong Daw), viết bằng RPA.
2. Dịch để NGHE: câu ngắn, từ thông dụng trong đời sống bản làng.
3. Tên giấy tờ và cơ quan: dịch nghĩa rồi mở ngoặc giữ nguyên tiếng Việt.
4. Con số, ngày, số tiền: GIỮ NGUYÊN dạng chữ số.
5. Không thêm, không bớt, không giải thích. Chỉ trả về bản dịch.
6. Từ nào không chắc, giữ nguyên tiếng Việt.
{glossary}
"""

SYSTEM_DICH_NGUOC = """\
Bạn là phiên dịch viên Mông – Việt. Dịch sang tiếng Việt tự nhiên, giữ đúng ý hỏi.
...
def _dich_google_nmt(text: str, sang_mong: bool) -> str:
    ...
    return client.translate(text, source_language=src, target_language=dst, format_="text")["translatedText"]
